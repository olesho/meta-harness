...
import { SchemaVersion, SourceLive, } from "../../transcript/index.js";
import { AcquisitionModeStream, } from "../../turns/index.js";
import { admitParent } from "./filter.js";
/**
...
export class StreamTap {
    ...
    emit(pe) {
        ...
        if (!admitParent(this.cfg.mode, source, pe.event.type ?? "", isSubagent)) {
            return true;
        }
        const ev = { ...pe.event };
        ev.seq = this.seq;
    ...
    backfill() {
        ...
        for (const env of this.pending) {
            if (env.harnessSessionID === "")
                env.harnessSessionID = id;
        }
 ...
 */
export function adapterStreamParser(adapter) {
    const a = adapter;
    if (a && typeof a.parseStreamLine === "function") {
        return (line) => a.parseStreamLine.call(a, line);
    }
    return null;
}
//# sourceMappingURL=streamTap.js.map