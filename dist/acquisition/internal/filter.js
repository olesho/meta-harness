...
import { AcquisitionModeHooks, AcquisitionModeStream, } from "../../turns/index.js";
import { EventText, EventToolResult, EventToolUse, SourceFile, SourceLive, } from "../../transcript/index.js";
 ...
 */
export function admitParent(effectiveMode, source, kind, isSubagent) {
    if (isSubagent) {
        return true;
    }
 ...
 */
export function isParentConversationKind(kind) {
    switch (kind) {
        case EventText:
        case EventToolUse:
