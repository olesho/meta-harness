...
import { CodeAuthRequired, CodeBillingWall, CodeUsageLimited, ReasonAuthRequired, ReasonBillingWall, ReasonUsageLimited, } from "./types.js";
import { RoleAssistant } from "../transcript/event.js";
/**
 ...
 */
export function apiErrorVerdictFrom(turns, watermark) {
 ...
 */
export function turnReason(v, harness) {
 ...
 */
export function oneLineCapped(s, max) {
