...
import { matchAny, matchPromptSuffix, } from "./detector/detector.js";
import { classFromHTTPCode, costClass, ErrRateLimited, retryClass, } from "./errorclass.js";
import { StatusAPIError, StatusBlockedByCost, StatusRetryLater, StatusWaitingForInput, } from "./status.js";
 ...
 */
export function matchTransportRetry(lower) {
...
function formatAPIErrorReason(hit) {
    if (hit.code === 0)
