...
// but harnessargs.ts.
import { argsContainAnyFlag, argsContainConfigKey, configKeyValue, flagValue, normHarness, } from "./harnessargs.js";
 ...
 */
export function permissionRungs() {
    return [
        PermissionModePlan,
 ...
 */
export function morePermissive(a, b) {
 ...
 */
export function effectiveLaunchRung(harness, args, mode) {
...
function codexLaunchRung(args, mode) {
    ...
    if (argsContainAnyFlag(args, codexProfileFlags))
        return "";
    if (sandboxCfgOK)
        return "";
    ...
    if (sandboxOK) {
        ...
        if (approvalOK && approval !== "")
            return codexPairRung(sandbox, approval);
 ...
 */
function codexPairRung(sandbox, approval) {
    ...
    if (sandbox === CodexSandboxDangerFullAccess &&
 ...
 */
function codexSandboxRung(value) {
    switch (value) {
 ...
 */
function codexRung(value) {
    if (value === PermissionModePlan)
        return PermissionModeManual;
...
//# sourceMappingURL=permissionrungs.js.map