...
describe("parseRetryAfter", () => {
  const cases: { name: string; in: string; want: number }[] = [
    {
      name: "H1: numeric seconds spelled out",
      in: "Retry after 30 seconds.",
      want: 30_000,
    },
    {
      name: "H2: numeric minutes spelled out",
      in: "Try again in 2 minutes.",
      want: 2 * 60_000,
    },
    ...
    {
      name: "mid-message minutes",
      in: "the upstream said try again in 10 minutes please",
      want: 10 * 60_000,
    },
...
describe("parseResetTime", () => {
  ...
  const cases: {
    ...
    {
      name: "R1: verbatim banner — same-day future",
      in: "You've hit your session limit · resets 6:40pm (Europe/Warsaw)",
      now: nowAfternoon,
      wantOK: true,
      want: nowIn(warsaw, "2026-05-20T18:40"),
    },
    {
      ...
      now: nowEvening,
      wantOK: true,
      want: nowIn(warsaw, "2026-05-21T18:40"),
    },
    {
      name: "R3: 12pm (noon) resolves to 12:00",
      in: "resets 12pm (UTC)",
      now: nowIn(utc, "2026-05-20T09:00"),
      wantOK: true,
      want: nowIn(utc, "2026-05-20T12:00"),
    },
    {
      name: "R4: 12am (midnight) resolves next day",
      in: "resets 12am (UTC)",
      now: nowIn(utc, "2026-05-20T09:00"),
      wantOK: true,
      want: nowIn(utc, "2026-05-21T00:00"),
    },
    {
      name: "R5: no TZ — caller location",
      in: "resets 5pm",
      now: nowIn(la, "2026-05-20T09:00"),
      wantOK: true,
      want: nowIn(la, "2026-05-20T17:00"),
    },
    {
    ...
    {
      name: "R8: unrecognized TZ falls back",
    ...
    {
      name: "R10: bare single-digit 24h rejected",
      in: "resets 6 (UTC)",
      now: nowAfternoon,
      wantOK: false,
    },
